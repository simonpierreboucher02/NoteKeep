...
import type { Note, InsertNote, UpdateNote, Folder } from "@shared/schema";
...
export default function Editor({ noteId, onNoteCreated, onNoteDeleted }: EditorProps) {
          ...
          <div className="flex-1 flex">
            ...
            <div className="flex-1 flex flex-col border-r border-border">
              ...
              <Textarea
                ...
                className="flex-1 border-none resize-none focus:ring-0 font-mono text-sm leading-relaxed p-6"
